...
async def get_policy_registry() -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get policy registry")
...
async def get_policy_info(policy_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get policy info")
...
async def get_policy_schema(policy_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get policy schema")
...
async def validate_content(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Policy validation failed")
