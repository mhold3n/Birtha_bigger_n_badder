...
# Router service
cd /workspace/services/router
pip install -e ".[dev]"

# Worker client
cd /workspace/services/worker_client
pip install -e ".[dev]"

# MCP servers
cd /workspace/mcp/servers/filesystem-mcp
pip install -e ".[dev]"

cd /workspace/mcp/servers/secrets-mcp
pip install -e ".[dev]"

cd /workspace/mcp/servers/vector-db-mcp
pip install -e ".[dev]"

# GitHub MCP server (Node.js)
cd /workspace/mcp/servers/github-mcp
